...
const Datenschutzerklarung = () => {
    return (
        <>
            <Navbar></Navbar>
            <h1 className="text-xl md:text-4xl text-center font-bold pt-6 pb-8">Datenschutzerklärung</h1>
            <div className="w-[85vw] md:w-[70vw] m-auto space-y-4 text-md md:text-lg text-justify">
                <p>Personenbezogene Daten (nachfolgend zumeist nur „Daten“ genannt) werden von uns nur im Rahmen der Erforderlichkeit sowie zum Zwecke der Bereitstellung eines funktionsfähigen und nutzerfreundlichen Internetauftritts, inklusive seiner Inhalte und der dort angebotenen Leistungen, verarbeitet.</p>
                <p>Gemäß Art. 4 Ziffer 1. der Verordnung (EU) 2016/679, also der Datenschutz-Grundverordnung (nachfolgend nur „DSGVO“ genannt), gilt als „Verarbeitung“ jeder mit oder ohne Hilfe automatisierter Verfahren ausgeführter Vorgang oder jede solche Vorgangsreihe im Zusammenhang mit personenbezogenen Daten, wie das Erheben, das Erfassen, die Organisation, das Ordnen, die Speicherung, die Anpassung oder Veränderung, das Auslesen, das Abfragen, die Verwendung, die Offenlegung durch Übermittlung, Verbreitung oder eine andere Form der Bereitstellung, den Abgleich oder die Verknüpfung, die Einschränkung, das Löschen oder die Vernichtung. q</p>
                <p>Mit der nachfolgenden Datenschutzerklärung informieren wir Sie insbesondere über Art, Umfang, Zweck, Dauer und Rechtsgrundlage der Verarbeitung personenbezogener Daten, soweit wir entweder allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung entscheiden. Zudem informieren wir Sie nachfolgend über die von uns zu Optimierungszwecken sowie zur Steigerung der Nutzungsqualität eingesetzten Fremdkomponenten, soweit hierdurch Dritte Daten in wiederum eigener Verantwortung verarbeiten.</p>
                <strong className="block font-semibold pt-4">Unsere Datenschutzerklärung ist wie folgt gegliedert:</strong>
                ...
                <h2 className="text-lg md:text-2xl font-bold pt-8">I. Informationen über uns als Verantwortliche</h2>
                <strong className="block font-semibold pt-4">Verantwortlicher Anbieter dieses Internetauftritts im datenschutzrechtlichen Sinne ist:</strong>
                <p>Alexander Meier</p>
                <p>Manchingerstr. 10,</p>
                <p>85053 Ingolstadt</p>
                <p>Deutschland</p>
                <p>Telefon: +49 841 9817 858</p>
                <p>E-Mail: meier-finanz@gmx.de</p>

                <h2 className="text-lg md:text-2xl font-bold pt-8">II. Rechte der Nutzer und Betroffenen</h2>
                ...
                <h2 className="text-lg md:text-2xl font-bold pt-8">III. Informationen zur Datenverarbeitung</h2>
                <p>Ihre bei Nutzung unseres Internetauftritts verarbeiteten Daten werden gelöscht oder gesperrt, sobald der Zweck der Speicherung entfällt, der Löschung der Daten keine gesetzlichen Aufbewahrungspflichten entgegenstehen und nachfolgend keine anderslautenden Angaben zu einzelnen Verarbeitungsverfahren gemacht werden.</p>
                <h3>Cookies</h3>
                <b>a) Sitzungs-Cookies/Session-Cookies</b>
                ...
                <p>https://www.facebook.com/legal/terms/page_controller_addendum</p>
                ...
                <p>https://policy.pinterest.com/de/privacy-policy</p>
                ...
                <p>Allgemeine Verlinkung auf Profile bei Drittanbietern</p>
                ...
                <p>Datenschutzerklärung: https://www.facebook.com/policy.php</p>
                <b>Instagram</b>
                <p>Meta Platforms Ireland Limited, 4 Grand Canal Square, Dublin 2, Irland.</p>
                <p>Datenschutzerklärung: https://help.instagram.com/519522125107875</p>
                <b>LinkedIn</b>
                ...
                <p>Datenschutzerklärung: https://www.linkedin.com/legal/privacy-policy</p>
                <b>Pinterest</b>
                <p>Pinterest Inc., 651 Brannan Street, San Francisco, CA, 94107, USA.</p>
                <p>Datenschutzerklärung: https://policy.pinterest.com/de/privacy-policy</p>
                <b>twitter</b>
                <p>Twitter Inc., 795 Folsom St., Suite 600, San Francisco, CA 94107, USA</p>
                <p>Datenschutzerklärung: https://twitter.com/privacy</p>
                <b>YouTube</b>
                ...
                <h3>Einsatz von PayPal als Zahlungsart</h3>
                ...
                <p>Diese Übermittelung ist zur Abwicklung Ihrer Bestellung mit der von Ihnen ausgewählten Zahlungsart notwendig, insbesondere zur Bestätigung Ihrer Identität, zur Administration Ihrer Zahlung und der Kundenbeziehung. Die Übermittlung Ihrer Daten an PayPal erfolgt daher auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO.</p>
                ...
                <h3>Einsatz von Sofortüberweisung als Zahlungsart</h3>
                <p>Sollten Sie sich im Rahmen Ihres Bestellvorgangs für eine Bezahlung mit dem Online-Zahlungsdienstleister Sofortüberweisung entscheiden, werden im Rahmen der so ausgelösten Bestellung Ihre Kontaktdaten an Sofortüberweisung übermittelt.</p>
                <p>Sofortüberweisung ist ein Angebot der SOFORT GmbH, Theresienhöhe 12, 80339 München, Deutschland. Sofortüberweisung übernimmt dabei die Funktion eines Online-Zahlungsdienstleisters, der eine bargeldlose Zahlung von Produkten und Dienstleistungen im Internet ermöglicht.</p>
                <p>Bei den an Sofortüberweisung übermittelten personenbezogenen Daten handelt es sich zumeist um Vorname, Nachname, Adresse, Telefonnummer, IP-Adresse, E-Mail-Adresse, oder andere Daten, die zur Bestellabwicklung erforderlich sind, als auch Daten, die im Zusammenhang mit der Bestellung stehen, wie Anzahl der Artikel, Artikelnummer, Rechnungsbetrag und Steuern in Prozent, Rechnungsinformationen, usw.</p>
                <p>Diese Übermittelung ist zur Abwicklung Ihrer Bestellung mit der von Ihnen ausgewählten Zahlungsart notwendig, insbesondere zur Bestätigung Ihrer Identität, zur Administration Ihrer Zahlung und der Kundenbeziehung. Die Übermittlung Ihrer Daten an SOFORT GmbH erfolgt daher auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO.</p>
                <p>Bitte beachten Sie jedoch: Personenbezogenen Daten können seitens Sofortüberweisung auch an Leistungserbringer, an Subunternehmer oder andere verbundene Unternehmen weitergegeben werden, soweit dies zur Erfüllung der vertraglichen Verpflichtungen aus Ihrer Bestellung erforderlich ist oder die personenbezogenen Daten im Auftrag verarbeitet werden sollen.</p>
                <p>Unter Umständen werden die an Sofortüberweisung übermittelten personenbezogenen Daten von Sofortüberweisung an Wirtschaftsauskunfteien übermittelt. Diese Übermittlung dient der Identitäts- und Bonitätsprüfung in Bezug auf die von Ihnen getätigte Bestellung.</p>
                <p>Welche Datenschutzgrundsätze Sofortüberweisung bei der Verarbeitung Ihrer Daten zugrunde legt, können Sie den Datenschutzhinweisen entnehmen, die Ihnen während des Zahlungsvorgangs von Sofortüberweisung angezeigt werden.</p>
                <p>Bei weiteren Fragen zur Verwendung Ihrer personenbezogenen Daten können Sie sich an Sofortüberweisung per E-Mail (datenschutz@sofort.com) oder schriftlich (SOFORT GmbH, Datenschutz, Theresienhöhe 12, 80339 München) wenden.</p>
                ...
                <p>_</p>
                <p>Die USA verfügen gegenwärtig nach Ansicht der Datenschutzaufsichtsbehörden allerdings nicht über ein angemessenes Datenschutzniveau. Es bestehen allerdings sogenannte Standardvertragsklauseln:</p>
                <p>https://faq.whatsapp.com/general/about-standard-contractual-clauses</p>
                <p>Jedoch sind dies privatrechtliche Vereinbarungen und haben daher keine direkte Auswirkung auf die Zugriffsmöglichkeiten der Behörden in den USA.</p>
                <p>_</p>
                ...
                <p><a href="https://www.xn--generator-datenschutzerklrung-pqc.de/">Muster-Datenschutzerklärung</a> der <a href="https://www.xn--bewertung-lschen24-n3b.de/">Anwaltskanzlei Weiß & Partner</a></p>
            </div>
