        ...
        <>
            ...
            <div className="relative flex flex-col items-center justify-center h-150 row w-[100vw]">
                    ...
                    <div className="flex justify-center gap-x-20 pt-15">
                        ...
                        <button className="bg-[#093B3F] text-white w-55 h-10 rounded-full text-lg" onClick={() => navigate('/wohnungen')}>WOHNUNGEN</button>
                        <button className="bg-[#093B3F] text-white w-55 h-10 rounded-full text-lg" onClick={() => navigate('/house')}>HÄUSER</button>
                    </div>
            </div>
        </>
    )
