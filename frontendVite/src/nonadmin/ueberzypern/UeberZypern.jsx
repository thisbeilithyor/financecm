    ...
    return (
        <>
            ...
            <div className="flex justify-center items-center px-4 pt-5 md:pt-10 pb-10">
                <img className="max-md:hidden w-[30vw] object-cover mx-2 !border-0 !border-transparent !rounded-2xl" src="relImg3.webp"></img>     
                <img className="w-[100vw] md:w-[30vw] object-cover mx-2 !border-0 !border-transparent !rounded-2xl" src="showImg1.webp"></img>
                <img className="max-md:hidden w-[30vw] object-cover mx-2 !border-0 !border-transparent !rounded-2xl" src="boat.webp"></img>
            </div>
