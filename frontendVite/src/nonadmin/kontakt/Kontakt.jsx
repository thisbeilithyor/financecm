...
const Kontakt = () => {
    ...
    return (
        <>
            ...
            <div className="md:flex justify-between md:justify-center bg-[#093B3F] pt-5 md:pt-40 md:space-x-10 lg:space-x-5">
                <a href="https://wa.me/491727745656" target="_blank" rel="noopener noreferrer">
                    <div className="flex justify-center items-center md:flex-col md:w-[25vw]">
                        <center><img className="!border-none w-[10vw] md:w-[8vw] lg:w-[5vw] mr-5 " src="phone.svg"></img></center>
                ...
                <div className="flex justify-center items-center md:flex-col md:w-[25vw] mt-3">
                    <center><img className="!border-none w-[10vw] md:w-[8vw] lg:w-[5vw] mr-1" src="location.svg"></img></center>
                ...
                <div className="flex justify-center items-center md:flex-col md:w-[25vw] mt-3">
                        <center><img className="!border-none w-[10vw] md:w-[8vw] lg:w-[5vw] mr-2" src="mail.svg"></img></center> 
